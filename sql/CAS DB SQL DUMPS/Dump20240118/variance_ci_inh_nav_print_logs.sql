...
--
-- Table structure for table `inh_nav_print_logs`
--

DROP TABLE IF EXISTS `inh_nav_print_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `inh_nav_print_logs` (
...
--
-- Dumping data for table `inh_nav_print_logs`
--

LOCK TABLES `inh_nav_print_logs` WRITE;
/*!40000 ALTER TABLE `inh_nav_print_logs` DISABLE KEYS */;
INSERT INTO `inh_nav_print_logs` VALUES (39,1,'./reports/inh-nav/PISI-#1.pdf','./reports/inh-nav/SUMPISI-#1.pdf',NULL,NULL,0,0,0,0,NULL),(40,2,'./reports/inh-nav/PISI-#2.pdf','./reports/inh-nav/SUMPISI-#2.pdf',NULL,NULL,0,0,0,0,NULL);
/*!40000 ALTER TABLE `inh_nav_print_logs` ENABLE KEYS */;
UNLOCK TABLES;
