...
--
-- Table structure for table `inh_print_logs`
--

DROP TABLE IF EXISTS `inh_print_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `inh_print_logs` (
...
--
-- Dumping data for table `inh_print_logs`
--

LOCK TABLES `inh_print_logs` WRITE;
/*!40000 ALTER TABLE `inh_print_logs` DISABLE KEYS */;
INSERT INTO `inh_print_logs` VALUES (1,2,'./reports/inh-inh/PISI-#2.pdf','./reports/inh-inh/SUMPISI-#2.pdf',NULL,NULL,0,0,0,0,NULL);
/*!40000 ALTER TABLE `inh_print_logs` ENABLE KEYS */;
UNLOCK TABLES;
